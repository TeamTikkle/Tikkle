...
let beer: TikkleSheet = TikkleSheet(image: UIImage(named: "beer"), title: "편의점 해외맥주 도장깨기", description: "편의점의 해외 맥주를 마셔보아요!", stampList:  [
...
let tripInKoreaTikkle: TikkleSheet = TikkleSheet(image: UIImage(named: "travel"), title: "꼭 가봐야 할 국내여행지", description: "국내 여행지를 돌아다녀 보아요!", stampList: [
...
let climbingTikkle = TikkleSheet(image: UIImage(named: "mountain"), title: "우리나라 등산코스 30곳 가보기", description: "국내에 여러 산들을 등산해보아요!", stampList: [
...
let tripOverseasTikkle: TikkleSheet = TikkleSheet(image: UIImage(named: "plane"), title: "해외여행지 도장깨기", description: "해외 여행지를 돌아다녀 보아요!", stampList: [
...
let coding: TikkleSheet = TikkleSheet(image: UIImage(named: "coding"), title: "8월 한달동안 1일 1커밋하기", description: "하루에 한번 의미있는 커밋을 하겠다!", stampList:  [
...
let coding2: TikkleSheet = TikkleSheet(image: UIImage(named: "coding"), title: "1일 1 커밋하기2222", description: "하루에 한번씩 커밋해보아요", stampList:  [
